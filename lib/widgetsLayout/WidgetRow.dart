...
/*
o row é um widget que organiza os filhos horizontalmente, um ao
lado do outro, dentro de um único eixo horizontal X da esquerda
para a direita

propriedades
children -> lista de widgets filhos alinhados horizotalmente 
